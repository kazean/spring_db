...
## 2. 런타임 예외 적용
- hello.jdbc.repository.<I> MemberRepository
- hello.jdbc.repository.<I> MemberRepositoryEx
- hello.jdbc.repository.MemberRepositoryV3 implements MebmerRepositoryEx
- hello.jdbc.repository.ex.MyDbException extends RuntimeException
...
- hello.jdbc.service.MemberServiceV4
> MemberRepository<I> 의존, throws SQLException 제거
- hello.jdbc.service.MemberServiceV4Test
...
- hello.jdbc.repository.ex.MyDuplicateKeyException extend MyDbException
> 이 예외는 우리가 직접 만든 것이기 때문에 특정 기술에 의존적이지 않다.
- hello.jdbc.exception.translator.ExTranslatorV1Test
```
class Service {
	try {
...
```
- MemberServiceV4Test - 수정 (MemberRepoV4_2) 및 테스트
- 정리
